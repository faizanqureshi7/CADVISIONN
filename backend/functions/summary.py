...
def generate_summary_with_gemini(composite_image: np.ndarray, 
    ...
    try:
        ...
        prompt = ("""You are analyzing a CAD/technical drawing revision comparison. The image shows:\n"
            ...
            "- **[Component Group/Area]:** Describe what changed and the impact in one clear sentence (15-25 words).\n\n"
            "Examples of good grouping:\n"
            "- **Mounting Interface (Grid C6):** Four components (C103, C208, R108, R109) repositioned northward by approximately 2mm to accommodate revised thermal clearance requirements.\n"
            "- **Capacitor Footprints:** Five capacitors (C57, C162, C181, C186, C215) updated from 0603 to 0805 package size to improve power handling capacity.\n\n"
